...
CFG_BIBCIRCULATION_LOAN_RULE_CODE_ABSOLUTE = 'Absolute day of year'
CFG_BIBCIRCULATION_LOAN_RULE_CODE_REGULAR = 'Regular'
CFG_BIBCIRCULATION_LOAN_RULE_CODE_HOURS_OVERNIGHT = 'Hours'
CFG_BIBCIRCULATION_LOAN_RULE_CODE_HOURS = 'Hours (no overnight)'
CFG_BIBCIRCULATION_LOAN_RULE_CODE_HOURS_MINUTE_OVERNIGHT = 'Hours+minutes'
CFG_BIBCIRCULATION_LOAN_RULE_CODE_HOURS_MINUTE = 'Hours+minutes (no overnight)'
