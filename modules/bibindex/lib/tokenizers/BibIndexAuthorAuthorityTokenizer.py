...
class BibIndexAuthorAuthorityTokenizer(BibIndexFullTokenizer):
    ...
    def tokenize_for_pairs(self, phrase, recid):
        ...
        if not self.isAuthority(recid):
            return []
        return super(BibIndexAuthorAuthorityTokenizer, self).tokenize_for_pairs(phrase, recid)
    ...
    def tokenize_for_words_default(self, phrase, recid):
        ...
        return super(BibIndexAuthorAuthorityTokenizer, self).tokenize_for_words(phrase, recid)
