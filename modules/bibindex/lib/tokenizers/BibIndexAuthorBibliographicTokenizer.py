...
class BibIndexAuthorBibliographicTokenizer(BibIndexFullTokenizer):
    ...
    def __init__(self, stemming_language=None, remove_stopwords=False, remove_html_markup=False,
        ...
        BibIndexFullTokenizer.__init__(self, stemming_language,
                                          remove_stopwords,
                                          remove_html_markup,
                                          remove_latex_markup)
    ...
    def tokenize_for_pairs(self, phrase, recid):
        ...
        """
        if not self.isBibliographic(recid):
            return []
        return super(BibIndexAuthorBibliographicTokenizer, self).tokenize_for_pairs(phrase, recid)

    def tokenize_for_phrases(self, phrase, recid):
        """
            Another name for tokenize_for_fuzzy_authors.
            It's for the compatibility.
            See: tokenize_for_fuzzy_authors
    ...
    def tokenize_for_words_default(self, phrase, recid):
        """Default tokenize_for_words inherited from default tokenizer"""
        return super(BibIndexAuthorBibliographicTokenizer, self).tokenize_for_words(phrase, recid)
    ...
    def tokenize_for_words(self, phrase, recid):
        ...
        if CFG_BIBINDEX_AUTHOR_WORD_INDEX_EXCLUDE_FIRST_NAMES:
            ...
            return self.tokenize_for_words_default(phrase, recid)


    def isBibliographic(self, recid):
