...
class BibIndexRenewalsTindTokenizer(BibIndexRecJsonTokenizer):
    """
    ...
    def tokenize(self, recid):
        ...
        try:
            return [run_sql("select SUM(number_of_renewals) from crcLOAN where id_bibrec={0}".format(recid))[0][0]]
