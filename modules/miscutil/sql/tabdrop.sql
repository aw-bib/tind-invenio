...
DROP TABLE IF EXISTS crcLOAN_RULES
DROP TABLE IF EXISTS crcRULES_SELECTION
DROP TABLE IF EXISTS crcPATRONTYPES
DROP TABLE IF EXISTS crcPATRONTYPE_BORROWER
DROP TABLE IF EXISTS crcITEMTYPES
DROP TABLE IF EXISTS crcITEMTYPE_ITEM
DROP VIEW IF EXISTS crcLOANRULES_MATCH_VIEW
-- end of file
